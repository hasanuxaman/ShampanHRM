...
";
        ...
        public string SelectEmpByCode(string Code, SqlConnection VcurrConn = null, SqlTransaction Vtransaction = null)
        {
            ...
            try
            {
                ...
                sqlText = @"Select AttnUserId from EmployeeInfo where Code=@Code ";
                SqlCommand objComm = new SqlCommand();
...
";
        ...
        //==================SelectAll=================
        public List<EmployeeInfoVM> SelectAll(string DOJFrom = "", string DOJTo = "")
        {
            #region Variables
            SqlConnection currConn = null;
            string sqlText = "";
...
,@PhotoName
                    ...
                    cmdInsert.Parameters.AddWithValue("@Salutation_E", vm.Salutation_E ?? Convert.DBNull);
                ...
                {
                    if (string.IsNullOrWhiteSpace(vm.personalDetail.OtherId))
                    {
                        retResults[1] = "Please Enter the Employee OtherId !";
                        throw new ArgumentNullException(retResults[1], "");
                    }
                    if (string.IsNullOrWhiteSpace(vm.employeeJob.EmpCategory))
                    {
                        retResults[1] = "Please Enter the Employee EmpCategory !";
                        throw new ArgumentNullException(retResults[1], "");
                    }
                    if (string.IsNullOrWhiteSpace(vm.employeeJob.EmpJobType))
                    {
                        retResults[1] = "Please Enter the Employee EmpJob Type !";
                        throw new ArgumentNullException(retResults[1], "");
                    }
                    bool IsExist = false;
                    IsExist = _commonDal.OtherIdExistCheck(new[] { "Empd.OtherId", "Empj.EmpCategory", "Empj.EmpJobType" }, new[] { vm.personalDetail.OtherId, vm.employeeJob.EmpCategory, vm.employeeJob.EmpJobType }, currConn, transaction);
                    if(IsExist)
                    {
                        retResults[1] = " This" + vm.personalDetail.OtherId + "Already exist for Other Employee!";
                        throw new ArgumentNullException(" This" + vm.personalDetail.OtherId + "Already exist for Other Employee!", "");
                    }
                    else
                    {
                        #region Employee Personal Detail
                        EmployeePersonalDetailDAL empPersonalDetail = new EmployeePersonalDetailDAL();
                        EmployeePersonalDetailVM empPersonalDetailVM = new EmployeePersonalDetailVM();
                        empPersonalDetailVM.EmployeeId = vm.Id;
                        empPersonalDetailVM.OtherId = vm.personalDetail.OtherId;
                        empPersonalDetailVM.Nationality_E = "Bangladesh";
                        empPersonalDetailVM.CreatedBy = vm.CreatedBy;
                        empPersonalDetailVM.CreatedAt = vm.CreatedAt;
                        empPersonalDetailVM.CreatedFrom = vm.CreatedFrom;
                        
                        string[] PersonalDetailResult = empPersonalDetail.Insert(empPersonalDetailVM, currConn, transaction);
                        if (PersonalDetailResult[0] == "Fail")
                        {
                            throw new ArgumentNullException(PersonalDetailResult[1], "");
                        }
                        #endregion 

                        #region Employee job
                        EmployeeJobDAL empJob = new EmployeeJobDAL();
                        EmployeeJobVM empJobVM = new EmployeeJobVM();
                        empJobVM.EmployeeId = vm.Id;
                        empJobVM.EmpCategory = vm.employeeJob.EmpCategory;
                        empJobVM.EmpJobType = vm.employeeJob.EmpJobType;
                        empJobVM.ProjectId = "1_1";
                        empJobVM.DepartmentId = "1_1";
                        empJobVM.SectionId = "1_1";
                        empJobVM.DesignationId = "1_1";
                        empJobVM.IsPermanent = true;
                        empJobVM.EmploymentStatus_E ="1";
                        empJobVM.EmploymentType_E = "1";
                        empJobVM.ProbationMonth = 0;
                        empJobVM.ExtendedProbationMonth = 0;
                        empJobVM.CreatedBy = vm.CreatedBy;
                        empJobVM.CreatedAt = vm.CreatedAt;
                        empJobVM.CreatedFrom = vm.CreatedFrom;
                        string[] empJobResult = empJob.Insert(empJobVM, currConn, transaction);
                        if (empJobResult[0] == "Fail")
                        {
                            throw new ArgumentNullException(empJobResult[1], "");
                        }
                        #endregion 
                ...
                if (CompanyName.ToUpper() != "G4S")
                {
                    ...
                    EmployeeStructureGroupDAL empStructureGroup = new EmployeeStructureGroupDAL();
                    EmployeeStructureGroupVM empStructureGVM = new EmployeeStructureGroupVM();
                    empStructureGVM.EmployeeId = vm.Id;
                    empStructureGVM.LeaveStructureId = "0";
                    empStructureGVM.SalaryStructureId = "0";
                    empStructureGVM.PFStructureId = "0";
                    empStructureGVM.TaxStructureId = "0";
                    empStructureGVM.BonusStructureId = "0";
                    empStructureGVM.EmployeeGroupId = "0";
                    empStructureGVM.Remarks = "";
                    empStructureGVM.IsActive = true;
                    empStructureGVM.IsArchive = false;
                    empStructureGVM.CreatedBy = vm.CreatedBy;
                    empStructureGVM.CreatedAt = vm.CreatedAt;
                    empStructureGVM.CreatedFrom = vm.CreatedFrom;
                    string[] innerResult = empStructureGroup.Insert(empStructureGVM, currConn, transaction);
                    if (innerResult[0] == "Fail")
                    {
                        throw new ArgumentNullException(innerResult[1], "");
                    }
                    #endregion
                }
...
";
            ...
            )
        {
            ...
            try
            {
                ...
                #region sql statement
                sqlText = @"
select e.id, e.Code,ed.OtherId ,e.Salutation_E, e.MiddleName, e.LastName
,e.Department ,e.DepartmentId
,e.Designation,e.DesignationId
,e.JoinDate
,ed.DateOfBirth,DATEADD(year, 65,ed.DateOfBirth) AS RetirementDate
,e.Branch
,e.Project ,e.Id ProjectId
,e.Section ,e.Id SectionId
,ty.Name EmploymentType_E
,ty.id EmploymentType_EId
,ed.CorporateContactNo Mobile
,a.Address ,a.District,a.Division,a.Country
,ed.Gender_E
,ed.Religion
,e.Grade
...
,Se.Email SupervisorEmail
,j.DotedLineReport DotedLineManager
,Se1.Email DotedLineManagerEmail

,en.Name as NomineeName
,en.Relation NRelation
,en.Mobile NMobile
,en.DateofBirth NDateofBirth
,en.Address NAddress
,en.PostalCode NPostalCode
,en.District NDistrict
,en.Division NDivision
,en.Country NCountry

,edp.Name as DependentName
,edp.Relation DRelation
,edp.Mobile DMobile
,edp.DateofBirth DDateofBirth
,edp.Address DAddress
,edp.PostalCode DPostalCode
,edp.District DDistrict
,edp.Division DDivision
,edp.Country DCountry
