...
{
    public class GFEmployeeBreakMonthDAL
    {
        ...
        public List<EmployeeBreakMonthGFVM> SelectAll(string empid = null)
        {
            ...
            string sqlText = "";
            List<EmployeeBreakMonthGFVM> vms = new List<EmployeeBreakMonthGFVM>();
            EmployeeBreakMonthGFVM vm;
            #endregion
            try
            {
...
,e.Code
,e.Designation
,e.Department, e.JoinDate, e.Section, e.Project, isnull(e.GrossSalary,0)GrossSalary,isnull(e.BasicSalary,0)BasicSalary
...
";
        ...
        public List<EmployeeBreakMonthGFVM> SelectAllList(string empid = null, string[] conditionFields = null, string[] conditionValues = null, SqlConnection VcurrConn = null, SqlTransaction Vtransaction = null)
        {
...
";
        ...
        //==================Insert =================
        public string[] Insert(EmployeeBreakMonthGFVM vm, SqlConnection VcurrConn, SqlTransaction Vtransaction)
        {
            #region Initializ
            string sqlText = "";
            int Id = 0;
            ...
            try
            {
                ...
                //sqlText = "  ";
                //sqlText += " SELECT   count(Id) FROM GFEmployeeBreakMonth ";
                ...
                vm.Id = cdal.NextId("GFEmployeeBreakMonth", currConn, transaction).ToString();

                if (vm != null)
                {
                    sqlText = "  ";
                    sqlText += @" INSERT INTO GFEmployeeBreakMonth
(
 Id
,EmployeeId
...
, @CreatedFrom
                ...
                {
                    retResults[1] = "Please Input GFEmployeeBreakMonth Value";
                    throw new ArgumentNullException("Please Input GFEmployeeBreakMonth Value", "");
                }
        ...
        //==================Update =================
        public string[] Update(EmployeeBreakMonthGFVM vm, SqlConnection VcurrConn, SqlTransaction Vtransaction)
        {
            #region Variables
            ...
            retResults[3] = "sqlText"; //  SQL Query
            retResults[4] = "ex"; //catch ex
            retResults[5] = "GFEmployeeBreakMonth Update"; //Method Name
            ...
            try
            {
                ...
                if (transaction == null) { transaction = currConn.BeginTransaction("UpdateToEmployeeBreakMonth"); }
                ...
                if (vm != null)
                {
                    ...
                    sqlText = "  ";
                    sqlText += " SELECT COUNT( Id)Id FROM GFEmployeeBreakMonth ";
                    ...
                    sqlText = "  ";
                    sqlText += " SELECT isnull(Post,0) FROM GFEmployeeBreakMonth ";
                    sqlText += " WHERE Id=@Id";
                    ...
                    sqlText = "";
                    sqlText = "update GFEmployeeBreakMonth set";
                ...
                {
                    retResults[0] = "Fail";
                    retResults[1] = "Unexpected error to update GFEmployeeBreakMonth.";
        ...
        //==================Post =================
        public string[] Post(EmployeeBreakMonthGFVM vm, SqlConnection VcurrConn, SqlTransaction Vtransaction)
        {
            #region Variables
            ...
            retResults[3] = "sqlText"; //  SQL Query
            retResults[4] = "ex"; //catch ex
            retResults[5] = "GFEmployeeBreakMonth Post"; //Method Name
            ...
            try
            {
                ...
                {
                    retResults[0] = "Fail";
                    retResults[1] = "Unexpected error to Post GFEmployeeBreakMonth.";
                    throw new ArgumentNullException("", "");
                }
        ...
        //==================Delete =================
        public string[] MultiplePost(EmployeeBreakMonthGFVM vm, string[] Ids, SqlConnection VcurrConn, SqlTransaction Vtransaction)
        {
            #region Variables
            ...
            retResults[3] = "sqlText"; //  SQL Query
            retResults[4] = "ex"; //catch ex
            retResults[5] = "DeleteEmployeeBreakMonth"; //Method Name
            ...
            try
            {
                ...
                if (transaction == null) { transaction = currConn.BeginTransaction("PostToEmployeeBreakMonth"); }
                ...
                if (Ids.Length > 1)
                {
                    ...
                    for (int i = 0; i < Ids.Length - 1; i++)
                    {
                        ...
                        sqlText = "  ";
                        sqlText += " SELECT EmployeeId FROM GFEmployeeBreakMonth ";
                        sqlText += " WHERE Id=@Id ";
                        SqlCommand cmdExist = new SqlCommand(sqlText, currConn);
                        cmdExist.Transaction = transaction;
                ...
                {
                    retResults[1] = "Unexpected error to delete GFEmployeeBreakMonth Information.";
                    throw new ArgumentNullException("", "");
                }
            }
            #region catch
...
,Remarks
  FROM GFEmployeeBreakMonth pfo
 -- left outer join " + hrmDB + @".dbo.ViewEmployeeInformation emp on pfo.EmployeeId=emp.EmployeeId
...
";
        ...
        public string[] ImportExcelFile(string Fullpath, string fileName, ShampanIdentityVM auditvm, SqlConnection VcurrConn = null, SqlTransaction Vtransaction = null)
        {
            ...
            retResults[3] = sqlText; //  SQL Query
            retResults[4] = "ex"; //catch ex
            retResults[5] = "GFEmployeeBreakMonth"; //Method Name
            SqlConnection currConn = null;
            SqlTransaction transaction = null;
            #endregion
                ...
                foreach (DataRow item in dt.Rows)
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            sqlText += " SELECT Id from GFEmployeeBreakMonth WHERE EmployeeId=@EmployeeId ";
