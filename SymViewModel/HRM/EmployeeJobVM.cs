...
namespace SymViewModel.HRM
{
    public class EmployeeJobVM
    {
        ...
        [Display(Name = "Ext. Probation Month")]
        ...
        [Display(Name = "RetirementDate")]
        public string RetirementDate { get; set; }
        [Display(Name = "1st Ex.Date")]
        public string fristExDate { get; set; }
        [Display(Name = "2nd Ex.Date")]
        public string secondExDate { get; set; }
        [Display(Name = "Extention Y/N")]
        public string Extentionyn { get; set; }
        
        [Display(Name = "Contr.Ex Date")]
