...
namespace SymWebUI.Areas.PF.Controllers
{
    public class PFReportController : Controller
    {
        ...
        public ActionResult PFSunDataTemplate()
        {
            Session["permission"] = _repoSUR.SymRoleSession(identity.UserId, "10003", "add").ToString();
            return View("~/Areas/PF/Views/PFReport/PFSunDataTemplate.cshtml");

        }

        public ActionResult PFSunDataTemplates(PFReportVM vm)
        {
            try
            {
                ...
                dt = _repo.DataExportForSunTemplatePF(vm);

                string filename = " PF Employee and Company Contributions " + "-" + DateTime.Now.ToString("yyyy-MM-dd-HHmmss");
                ExcelPackage excel = new ExcelPackage();
                var workSheet = excel.Workbook.Worksheets.Add(" PF Employee and Company Contributions");
                ...
                string[] ReportHeaders = new string[] { " PF Employee and Company Contributions", Line1, Line2, Line3 };
                ...
                return Redirect("PF/PFReport/PFSunDataTemplates");
            }
            catch (Exception)
            {
                throw;
        ...
        public ActionResult PFProfitSunDataTemplate()
        {
            Session["permission"] = _repoSUR.SymRoleSession(identity.UserId, "10003", "add").ToString();
            return View("~/Areas/PF/Views/PFReport/PFProfitSunDataTemplate.cshtml");

        }

        public ActionResult PFProfitSunDataTemplates(PFReportVM vm)
        {
            try
            {
                DataTable dt = new DataTable();
                ...
                dt = _repo.DataExportForSunTemplatePFProfit(vm);

                string filename = " PF Profit Distributions" + "-" + DateTime.Now.ToString("yyyy-MM-dd-HHmmss");
                ExcelPackage excel = new ExcelPackage();
                var workSheet = excel.Workbook.Worksheets.Add(" PF Employee and Company Contributions");
                CompanyRepo cRepo = new CompanyRepo();
                CompanyVM comInfo = cRepo.SelectById(1);
                ...
                return Redirect("PF/PFReport/PFProfitSunDataTemplates");
            }
            catch (Exception)
            {
                throw;
        ...
        public ActionResult EmployeePFOpeinig_Statement(PFReportVM vm)
        {
            try
            {
                ...
                string filename = "EmployeePFOpeinig_Statement " + "-" + DateTime.Now.ToString("yyyy-MM-dd-HHmmss");
                ExcelPackage excel = new ExcelPackage();
                ...
                string[] ReportHeaders = new string[] { "Employee PF Opeinig Statement", Line1, Line2, Line3 };
