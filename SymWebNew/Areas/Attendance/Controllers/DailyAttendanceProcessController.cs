...
namespace SymWebUI.Areas.Attendance.Controllers
{
    ...
    {
        //
        // GET: /Attendance/DailyAttendanceProcess/
        ...
        [HttpGet]
        public ActionResult ReportView(string codeFrom, string codeTo, string departmentId, string projectId, string sectionId, string dtFrom, string dtTo, string attnStatus, string fullOT)
        {
            try
            {
                string ReportHead = "";
        ...
        public ActionResult Process1(string fydid = "")
        {
            ...
            result = _repo.Process1(fydid, vm);

            mgs = result[0] + "~" + result[1];
            return Json(mgs, JsonRequestBehavior.AllowGet);
        }
        //AttendanceDailyToMonthlyOTnAbsenceProcess
        public ActionResult Process2(string fydid = "")
        {
            if (string.IsNullOrWhiteSpace(fydid))
            {
                return View();
            ...
            result = _repo.Process2(fydid, vm);

            mgs = result[0] + "~" + result[1];
            return Json(mgs, JsonRequestBehavior.AllowGet);
        }
        //DailyOTnAbsenceToMonthlyOTnAbsenceProcess
        public ActionResult Process3(string fydid = "")
        {
            if (string.IsNullOrWhiteSpace(fydid))
            {
                return View();
            ...
            result = _repo.Process3(fydid, vm);
