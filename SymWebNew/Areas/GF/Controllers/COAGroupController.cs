...
namespace SymWebUI.Areas.GF.Controllers
{
    public class COAGroupController : Controller
    {
        ...
        public ActionResult _index(JQueryDataTableParamModel param)
        {
            ...
            var getAllData = _repo.SelectAll(0, new[] { "COAGroups.TransType" }, new[] { AreaTypeGFVM.TransType });
            ...
            if (!string.IsNullOrEmpty(param.sSearch))
            {
                ...
                filteredData = getAllData.Where(c =>
                    ...
                    //|| isSearchable1 && c.GroupType.ToLower().Contains(param.sSearch.ToLower())
            ...
            Func<COAGroupVM, string> orderingFunction = (c =>
                ...
                //sortColumnIndex == 1 && isSortable_1 ? c.GroupType :
                sortColumnIndex == 4 && isSortable_2 ? c.IsActive.ToString() :
