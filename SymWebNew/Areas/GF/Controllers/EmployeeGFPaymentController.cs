...
{
    public class EmployeeGFPaymentController : Controller
    {
        public EmployeeGFPaymentController()
        {
            ViewBag.TransType = AreaTypeGFVM.TransType;
        }
        EmployeeGFPaymentRepo _eaRepo = new EmployeeGFPaymentRepo();
        ...
        public ActionResult _index(JQueryDataTableParamVM param)
        {
            ...
            IEnumerable<EmployeeGFPaymentVM> filteredData;
            ...
            if (!string.IsNullOrEmpty(param.sSearch))
            {
                ...
                filteredData = getAllData.Where(c =>
                    ...
                    || isSearchable5 && c.PaymentDate.ToString().ToLower().Contains(param.sSearch.ToLower())
            ...
            Func<EmployeeGFPaymentVM, string> orderingFunction = (c =>
                ...
                sortColumnIndex == 5 && isSortable_5 ? c.PaymentDate.ToString() :
        ...
        public ActionResult SingleEmployeeGFPaymentEdit(string PFPaymentId, string Operation = "")
        {
            var permission = _reposur.SymRoleSession(identity.UserId, "1_38", "edit").ToString();
            Session["permission"] = permission;
            if (permission == "False")
            ...
            EmployeeGFPaymentVM empGFPaymentVM = new EmployeeGFPaymentVM();
            if (!string.IsNullOrWhiteSpace(PFPaymentId))
                empGFPaymentVM = _eaRepo.SelectByIdAll(PFPaymentId);
            EmployeeInfoVM vm = new EmployeeInfoVM();
            EmployeeInfoRepo repo = new EmployeeInfoRepo();
            if (!string.IsNullOrWhiteSpace(PFPaymentId) && !string.IsNullOrWhiteSpace(empGFPaymentVM.Id))
            {
                vm = repo.AllSelectById(empGFPaymentVM.EmployeeId);
            }
            vm.empGFPaymentVM = empGFPaymentVM;
            vm.Operation = Operation;
            Session["PFOpeinigId"] = empGFPaymentVM.Id;
            return View(vm);
        ...
        public ActionResult DetailCreate(string empcode = "", string btn = "current", string id = "0", string Operation = "")
        {
            ...
            EmployeeGFPaymentVM PFOpeinigVM = new EmployeeGFPaymentVM();
            EmployeeInfoVM vm = new EmployeeInfoVM();
            ...
            else
            {
                ...
                vm.empGFPaymentVM = PFOpeinigVM;
                vm.empGFPaymentVM.EmployeeId = EmployeeId;
                vm.Operation = Operation;
                if (vm.Operation.ToLower() == "add")
                {
                    vm.Id = null;
                    vm.empGFPaymentVM.Id = null;
                    vm.empGFPaymentVM.EmployerContribution = 0;
                    vm.empGFPaymentVM.EmployerProfit = 0;
                    vm.empGFPaymentVM.PaymentDate = null;
                    vm.empGFPaymentVM.Post = false;
                }
            }
        ...
        public ActionResult MultiplePost(string ids)
        {
            ...
            EmployeeGFPaymentVM EarningVM = new EmployeeGFPaymentVM();
        ...
        public ActionResult ImportEmployeeGFPayment()
        {
            var permission = _reposur.SymRoleSession(identity.UserId, "1_38", "add").ToString();
            Session["permission"] = permission;
            if (permission == "False")
        ...
        public ActionResult ImportExcel(HttpPostedFileBase file)
        {
            ...
            try
            {
                ...
                Session["result"] = result[0] + "~" + result[1];
                return RedirectToAction("ImportEmployeeGFPayment");
            ...
            , string Orderby = null)
        {
            ...
            try
            {
                ...
                string filename = "EmployeeGFPayment" + "-" + DateTime.Now.ToString("yyyyMMdd");
        ...
        public ActionResult reportVeiw(int id)
        {
            try
            {
                ...
                EmployeeGFPaymentVM EmployeeGFPaymentVM = new EmployeeGFPaymentVM();
                PFReport report = new PFReport();
                EmployeeGFPaymentVM = _eaRepo.SelectById(id.ToString());
                vm.Id = id;
                vm.Code = EmployeeGFPaymentVM.Code;
