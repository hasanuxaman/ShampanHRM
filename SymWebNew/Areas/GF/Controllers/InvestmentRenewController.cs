...
namespace SymWebUI.Areas.GF.Controllers
{
    public class InvestmentRenewController : Controller
    {
        ...
        public ActionResult _index(JQueryDataTableParamModel param, int investmentId = 0)
        {
            ...
            var getAllData = _repo.SelectAll(0, new[] { "inv.InvestmentId", "inv.TransType" }, new[] { investmentId.ToString(), AreaTypeGFVM.TransType });
        ...
        [Authorize(Roles = "Admin")]
        ////[HttpGet]
        public ActionResult Create(int investmentId = 0)
        {
            ...
            vm.InvestmentVm =  investmentRepo.SelectAll(investmentId).FirstOrDefault();
    ...
    [HttpPost]
        public ActionResult InvestmentRenew(PFReportVM vm)
        {
            try
            {
                ...
                var Result = _repo.SelectAll(Convert.ToInt32(vm.Id));
