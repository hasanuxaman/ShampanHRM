...
{
    public class Schedule2TaxSlabController : Controller
    {
        //
        // GET: /TAX/Schedule2Schedule2TaxSlab/

       Schedule2TaxSlabRepo _repo = new Schedule2TaxSlabRepo();
        Schedule2TaxSlabDetailRepo _detailRepo = new Schedule2TaxSlabDetailRepo();
        ...
        public ActionResult Index()
        {
            ...
            Schedule2TaxSlabVM vm = new Schedule2TaxSlabVM();
            return View(vm);
        }
        public ActionResult _index(JQueryDataTableParamVM param)
        {
            ...
            IEnumerable<Schedule2TaxSlabVM> filteredData;
            ...
            Func<Schedule2TaxSlabVM, string> orderingFunction = (c => sortColumnIndex == 1 && isSortable_1 ? c.Name :
        ...
        public ActionResult Create()
        {
            ...
            Schedule2TaxSlabVM vm = new Schedule2TaxSlabVM();
            List<Schedule2TaxSlabDetailVM> schedule2TaxSlabDVMs = new List<Schedule2TaxSlabDetailVM>();
            Schedule2TaxSlabDetailVM dVM = new Schedule2TaxSlabDetailVM();
            for (int i = 0; i < 6; i++)
            {
                dVM = new Schedule2TaxSlabDetailVM();
                dVM.SlabName = "Slab " + (i + 1);
                dVM.Ceiling = 0;
                dVM.Ratio = 0;
                schedule2TaxSlabDVMs.Add(dVM);
            }
            schedule2TaxSlabDVMs.Last().SlabName = "Above";


            vm.schedule2TaxSlabDetailVMs = schedule2TaxSlabDVMs;
            vm.Operation = "add";
            return View(vm);
        }

        [HttpPost]
        public ActionResult CreateEdit(Schedule2TaxSlabVM vm)
        {
        ...
        public ActionResult Edit(string id)
        {
            ...
            List<Schedule2TaxSlabDetailVM> schedule2TaxSlabDVMs = new List<Schedule2TaxSlabDetailVM>();
            schedule2TaxSlabDVMs = _detailRepo.SelectAll(0, Convert.ToInt32(id));
            vm.schedule2TaxSlabDetailVMs = schedule2TaxSlabDVMs;
            vm.Operation = "update";
            return View("Create", vm);
        }
